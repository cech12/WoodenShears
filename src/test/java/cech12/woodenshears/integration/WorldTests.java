...
public class WorldTests {
    ...
    public void testBreakingTallGrassAndLargeFern(IntegrationTestHelper helper) {
        ...
        ItemStack shears = new ItemStack(WoodenShearsItems.WOODEN_SHEARS);
    ...
    private void testBeehiveBlocksForHoneyLevel(IntegrationTestHelper helper, int honeyLevel) {
        ...
        ActionResult<ItemStack> beeNestResult = IntegrationTestUtils.useItem(helper, INTERACTION_POSITION, Direction.NORTH, new ItemStack(WoodenShearsItems.WOODEN_SHEARS));
        ActionResult<ItemStack> beeHiveResult = IntegrationTestUtils.useItem(helper, INTERACTION_POSITION.above(), Direction.NORTH, new ItemStack(WoodenShearsItems.WOODEN_SHEARS));
    ...
    public void testBreakingTripwire(IntegrationTestHelper helper) {
        ...
        ActionResult<ItemStack> actionResult = IntegrationTestUtils.destroyBlockWithItem(helper, tripwirePos, new ItemStack(WoodenShearsItems.WOODEN_SHEARS));

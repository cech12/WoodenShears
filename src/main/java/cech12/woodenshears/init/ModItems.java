...
public class ModItems {
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        WoodenShearsItems.WOODEN_SHEARS = registerItem("wooden_shears", new ShearsItem((new Item.Properties()).maxDamage(50).group(ItemGroup.TOOLS)));

        //register dispense behaviour (copy of shears)
        DispenserBlock.registerDispenseBehavior(WoodenShearsItems.WOODEN_SHEARS.asItem(), new OptionalDispenseBehavior() {
            /**

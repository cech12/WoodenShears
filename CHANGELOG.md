...
### Added
- the possibility to use wooden shears as fuel in furnaces like wooden shovels (all loaders) (thanks to bixqa for the idea) #39
- the possibility to fuse two damaged wooden shears via crafting for repairing (all loaders) (thanks to bixqa for the idea) #38
...
## [1.21.9-3.6.1.0] - 2025-11-05
### Added
- Added Japanese translation (thanks to Abbage230 for the contribution) #33
...
### Added
- added Wooden Shears to the `c:tools/shear` item tag (Fabric/Quilt & NeoForge) (thanks to Phoupraw for the suggestion) #17
...
### Fixed
- wooden shears could not be enchanted (all loaders)
